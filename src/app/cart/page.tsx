            ...
            <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                                ...
                                return (
                                    <li key={index} className="flex py-6 sm:py-10">
                                        ...
                                        <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                                            <div className="relative pr-9 sm:grd sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                                                <div>
                                                ...
                                                <div className="mt-4 sm:mt-0 sm:pr-9 w-20">
                                                    <div className="absolute right-0 top-0">
                                                        ...
                                                        }} aria-label="remove product"><X className="h-5 w-5" aria-hidden="true" /></Button>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <section className="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
                        ...
                        <div className="mt-6">
                            <Button onClick={} className="w-full" size="lg">Checkout</Button>
                        </div>
                    </section>
                </div>
            </div>
