...
const VerifyEmailPage = ({ searchParams }: PageProps) => {
    ...
    return (
        <div className="w-full container relative flex pt-20 flex-col items-center justify-center lg:px-0">
    ...
    />
                        ...
                        {toEmail ? <p className="text-muted-foreground text-center">
                            we&apos;ve sent a verification link to <span className="toEmail">{toEmail}</span>
