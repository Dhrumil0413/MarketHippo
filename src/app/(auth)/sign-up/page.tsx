            ...
            <div className="container relative flex pt-20 flex-col items-center justify-center lg:px-0">
                <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                    <div className="flex flex-col items-center space-y-2 text-center">
                        ...
                        <Link className={buttonVariants({ variant: 'link' })} href='/sign-in'>Already have an account? Sign-in
                            <ArrowRight className="h-4 w-4"></ArrowRight>
                        </Link>
                    </div>

                    {/* Actual Sing UP form here. This is where forms in React are used. */}
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="grid gap-2">
                                <div className="grid gap-1 py-2">
                                    ...
                                    <Input
                                        {...register("email")}
                                        type="email" className={cn({ "focus-visible:ring-red-500": errors.email })} placeholder="you@example.com" />
                                </div>
                                {/* Password field */}
                                <div className="grid gap-1 py-2">
                                    ...
                                    <Input
                                        {...register('password')}
                                        type="password" className={cn({ "focus-visible:ring-red-500": errors.password })} placeholder="password" />
                                </div>
